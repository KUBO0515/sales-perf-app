        ...
        <div className="mx-auto max-w-4xl space-y-8 rounded-2xl bg-white/90 p-8 shadow-md backdrop-blur">
          ...
          <label className="block font-semibold text-gray-700">
            ...
            <input
              ...
              value={formatName}
              onChange={(e) => setFormatName(e.target.value)}
              className="mt-2 w-full rounded-lg border border-gray-300 p-3 shadow-sm focus:border-gray-500 focus:ring-1 focus:ring-gray-300 focus:outline-none"
              placeholder="例: 営業日報"
            />
          </label>
          ...
          <div className="space-y-4">
            {inputs.map((input, index) => (
              <div key={index} className="space-y-3 rounded-xl p-4 shadow-sm">
                <div className="flex flex-col gap-3 md:flex-row md:items-center">
                  ...
                  <select
                    ...
                    className="w-40 rounded-lg border border-gray-300 p-3 shadow-sm focus:border-gray-500 focus:ring-1 focus:ring-gray-300 focus:outline-none"
                  >
                    <option value="text">テキスト</option>
                    <option value="number">数値</option>
                    <option value="select">選択</option>
          ...
          <button
            onClick={handleSubmit}
            className="mt-4 w-full cursor-pointer rounded-xl py-3 text-lg font-bold text-gray-600 shadow-md backdrop-blur-sm transition hover:bg-gray-50"
          >
            フォーマットを保存
          </button>
        </div>
